...
public class BotController : MonoBehaviour,IGameStateUser
{
    ...
    [Inject]
    private void Construct(VehicleConfig vehicleConfig, CheckpointBehaviour checkpointBehaviour,GameplayObserver gameplayObserver)
    {
        ...
        gameplayObserver.Register(this);
    }

    private void FixedUpdate()
    {
        if (raceTracker.IsStop || _gamePlayState != GamePlayState.Loop) return;
